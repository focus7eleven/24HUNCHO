...
import styles from './ChatBoxX.scss'
...
import mentionStyle from './mentionStyle.scss'
...
export default class ChatBox extends React.Component {
  ...
  componentWillReceiveProps({ members }) {
    const mentions = createMentions(members.toJS())
    this.setState({
  ...
  onSearchChange = ({ value }) => {
    ...
    this.setState({
      suggestions: defaultSuggestionsFilter(value, createMentions(members.toJS())),
    })
  }
  ...
  handleSendMessage = () => {
    ...
    if (contentState.hasText()) {
      ...
      this.props.onSend(emojione.toShort(message), Constants.CHAT_SUBTYPE.DEFAULT, apns)
