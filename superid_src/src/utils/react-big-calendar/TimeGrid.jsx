...
import DayColumn from './MyDayColumn';
  ...
  render() {
    ...
    return (
      <div className='rbc-time-view'>
        ...
        <div ref='content' className='rbc-time-content' style={{height: this.props.height}}>
          {
            this.renderEvents(range, allDayEvents, this.props.now)
          }
        </div>
      </div>
    );
