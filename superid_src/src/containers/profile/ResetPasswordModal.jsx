...
const ResetPasswordModal = React.createClass({
  ...
  render(){
    ...
    return (
      <Modal
        maskClosable={false}
        title="重置密码"
        wrapClassName={styles.resetPasswordModal}
        width={500}
        visible={visible}
        footer={[]}
        ...
        <div className={styles.container}>
          <Tabs defaultActiveKey={defaultActiveKey}>
            <TabPane
              ...
              key="phone"
            >
              <ResetPasswordForm handleCancel={this.handleCancel} resetType={RESET_TYPE.PHONE} user={user} ref={(el) => {this.resetByPhoneForm = el}} />
            </TabPane>
            <TabPane
              disabled={!hasEmail}
              ...
              key="email"
            >
              <ResetPasswordForm handleCancel={this.handleCancel} resetType={RESET_TYPE.EMAIL} user={user} ref={(el) => {this.resetByEmailForm = el}} />
            </TabPane>
          </Tabs>
        </div>
      </Modal>
